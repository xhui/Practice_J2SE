 ...
 * @author ochafik
 */
public class LockScreenBreaker
{
	...
	public static void main(String[] args)
	{
		JOptionPane
				.showMessageDialog(
						null,
						"This program will move mouse automaticly if you don't do anything in 2.5 minutes.\r\nKill the thread 'javaw.exe'if you want to stop it.");
		for (;;)
		{
			int idleTime = 150000 - getIdleTimeMillisWin32();
			if (idleTime <= 0)
			{
				try
				{
